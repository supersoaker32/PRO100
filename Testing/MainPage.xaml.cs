...
namespace Testing
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void Random_Click(object sender, RoutedEventArgs e)
        {
            ...
            List<string> backgrounds = new List<string>() { "Acolyte", "Charlatan", "Criminal", "Entertainer", "Folk Hero", "Guild Artisan", "Hermit", "Noble", "Outlander", "Sage", "Sailor", "Solider", "Urchin" };
            ...
            switch (bg)
            {
                case "Acolyte"://EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS
                    {
                        addBackgroundData(bg, new int[] { 6, 14 }, new List<string> { "{Language of Choice}", "{Language of Choice}" }, new List<string> { "Holy Symbol of Choice", "Prayer Book or Prayer Wheel", "5 Sticks of Incense", "Vestments", "Common Clothes"}, 15,
                                          new List<string> { "Shelter of the Faithful" }, new List<string> { "When you are in a temple that follows your faith, you are respected by the people who serve there and may ask for assistance from them for certain deeds." },
                                          /* TODO */new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break;
                case "Charlatan"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                          new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break; 
                case "Criminal"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                          new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break; 
                case "Entertainer"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                           new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break;
                case "Folk Hero"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                           new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break;
                case "Guild Artisan"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                          new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break;
                case "Hermit"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                          new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break; 
                case "Noble"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                          new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break;
                case "Outlander"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                           new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break;
                case "Sage"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                          new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break; 
                case "Sailor"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                           new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break;
                case "Solider"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                            new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
                    break;
                case "Urchin"://NAME SKILLS LANGUAGES EQUIPMENT FEATURENAMES FEATUREDESCS SUBBACKGROUND PERSONALITY IDEALS BONDS FLAWS "{Language of Choice}"
                    {
                        addBackgroundData(bg, new int[] { }, new List<string> { }, new List<string> { }, 0, new List<string> { }, new List<string> { },
                                          new List<string> { }, new List<string> { }, new List<string> { }, new List<string> { });
                    }
        ...
        private void addBackgroundData(string bgName, int[] skillProfs, List<string> languages, List<string> equipment, int gold, List<string> featureNames, List<string> featureDescs,
                                       List<string> Personalities, List<string> ideals, List<string> bonds, List<string> flaws)
        {
            ...
            if (ideals != null)
            {
                (App.Current as App).Character.CharactersInfo.Background[2] = Personalities[rng.Next(0, Personalities.Count)];
            }

            if (bonds != null)
            {
                (App.Current as App).Character.CharactersInfo.Background[3] = Personalities[rng.Next(0, Personalities.Count)];
            }

            if (flaws != null)
            {
                (App.Current as App).Character.CharactersInfo.Background[4] = Personalities[rng.Next(0, Personalities.Count)];
            }
            }
        }
